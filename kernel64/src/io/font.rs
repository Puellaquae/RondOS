//! 8x16 bitmap font for the framebuffer console.
//!
//! Generated by `tools/mkfont.py` from /usr/share/consolefonts/Lat15-VGA16.psf.gz — do not edit by hand.
...
/// One `FONT_HEIGHT`-byte column-major-by-row bitmap per glyph.
